...
<head>
  ...
  <title>GLDNBOY STORE - Admin <?php echo '| '.ucfirst($this->router->fetch_class()).' '?></title>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url(); ?>admin">
        <div class="sidebar-brand-icon">
          <img src="<?php echo base_url(); ?>assets/admin/img/logo/logo4.png">
        </div>
        <div class="sidebar-brand-text mx-2">gldnboyStore</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGoods" aria-expanded="true"
          aria-controls="collapseGoods">
          <i class="fas fa-fw fa-cubes"></i>
          <span>Goods</span>
        </a>
        <div id="collapseGoods" class="collapse" aria-labelledby="headingGoods" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Goods</h6>
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/product/add"><i class="fas fa-fw fa-plus-square"></i><span> New Product</span></a>
            <?php 
              foreach ($category as $data) {
                $str = strtolower($data->name_category);
                $strShow = ucwords(str_replace("-"," ",$data->name_category)); 
                if($strShow == "T Shirt"){
                  $strShow = "T-Shirt";
                }
                echo '
                <a class="collapse-item" href="'. base_url().'admin/product/'.$str.'">'.$strShow.'</a>
                ' ;   
              }
            ?>
          </div>
      ...
      <li class="nav-item">
        ...
        <div id="collapseCategory" class="collapse" aria-labelledby="headingCategory" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/category/newcategory"><i class="fas fa-fw fa-plus-square"></i><span> New Category</span></a>
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/category">List Category</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url(); ?>admin/promo">
      ...
      <li class="nav-item">
        ...
        <div id="collapseImages" class="collapse" aria-labelledby="headingImages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/images/instagram"> Instagram</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo base_url(); ?>assets/admin/img/man.png" style="max-width: 60px" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo base_url(); ?>assets/admin/img/girl.png" style="max-width: 60px" alt="">
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>COPYRIGHT &copy; <script> document.write(new Date().getFullYear()); </script> - 
              <b><a href="" target="_blank">GLDNBOYSTORE</a></b>
            </span>
          </div>
        </div>
      </footer>
